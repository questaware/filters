...
extern Cc   msd_init __((Char *, Char *, int));
extern Char * msd_nfile(int * fnoffs);
extern Cc msd_push __((void));
extern Char * msd_pop __((void));
extern int  msd_getprops __((Char * fn));
...
//#define msd_isslink() (msd_attrs & 256)
